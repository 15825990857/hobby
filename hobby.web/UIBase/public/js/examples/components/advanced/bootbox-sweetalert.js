...
(function (document, window, $) {
    ...
    $(function () {
        ...
        (function () {
            ...
            $(document).on('click', '#exampleBootboxPromptDefaultValue', function () {
                bootbox.prompt({
                    title: "你叫什么名字？",
                    value: "Admui",
            ...
            $(document).on('click', '#exampleBootboxCustomDialog', function () {
                bootbox.dialog({
                    message: "我是一个自定义对话框",
                    title: "自定义标题",
                    buttons: {
            ...
            $(document).on('click', '#exampleBootboxCustomHtmlContents', function () {
                bootbox.dialog({
                    title: "使用 HTML",
            ...
            $(document).on('click', '#exampleBootboxCustomHtmlForms', function () {
                bootbox.dialog({
                    title: "这是一个含表单的弹框",
        ...
        // --------------
        (function () {
            $(document).on("click", '#exampleWarningConfirm', function () {
                swal($.po('sweetalert', {
                        title: "您确定要这样做吗？",
                        text: "删除此文件后将无法恢复！",
                        type: "warning",
            ...
            $(document).on("click", '#exampleWarningCancel', function () {
                swal($.po('sweetalert', {
                        title: "您确定要这样做吗？",
                        text: "删除此文件后将无法恢复！",
                        type: "warning",
