    ...
    var $userAccont = $("#userAccountInfo");
     ...
     App.extend({
        handleAction: function () {
            ...
            $(document).on('click', '.site-action-toggle', '.site-action', function (e) { // 新增用户
            ...
            $(document).on('click', '[data-action="delete"]', '.site-action', function () { // 删除所选用户
            ...
            /* 选中用户 --禁止所选用户 */
            $(document).on('click', '[data-action="move"]', '.site-action', function (e) {
                var $tr = $('#user_tables').find('tbody > tr'),
                    userIds = [];
        ...
        currentRole: function ($item) {
            var $parents = $('.page-aside-inner'),
                ...
                url = ID === undefined ? '../../public/data/system/user.json' : '../../public/data/system/user.json?roleId=' + ID;
